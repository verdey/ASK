...
```
   ...
   (this thin index)                       and read it live
              │
              ├─▶  /Users/verdey/Documents/Claude/Projects/_flow-blueprint/
              ├─▶  /Users/verdey/Documents/Claude/Projects/Finance/Income/Flows/LOBs/wholesaling/
              ├─▶  /Users/verdey/Documents/Claude/Projects/Finance/Income/Income-Land-Deal-Search/
              ├─▶  /Users/verdey/Documents/Claude/Projects/Live/flows_deals/
              └─▶  /Users/verdey/Documents/Claude/Projects/Finance/Income/Flows/_flow-navigator/
```
...
- **Cap at 6 entries.** When a 7th flow earns showcase status, the weakest current entry rotates out (note in `lessons.md`).
- **Each entry teaches something distinct.** No two entries should exemplify the same lesson.
- **Updates via `/flow curate` → `/flow promote`.** Direct edits drift; the curate→promote cycle is the only sanctioned mutation path.
