...
- `graciela.brazos` — Wave 0 / 🗝️ Keeper / Haiku 4.5 — Emergency filing triage. Brief: `/Users/verdey/Documents/Claude/Projects/Finance/Income/docs/sessions/_session-graciela-brazos-emergency-triage.md` · ✅ **shipped** 2026-04-29. County → **Hood**; PWD-885 reframed as plan-narrative-attached-to-Form-50-129; 5-scenario tree (A / A-resign / B / C / D); phone-call packet ready at `_session-graciela-brazos-output-chance-phone-call.md`; April-30 fire is conditional, not absolute. 0 deviations harmful, 1 reframe helpful.
  ...
  - `graciela.frio` — Wave 2 / ⚡ Catalyst / Sonnet 4.6 — **EXPANDED 2026-04-29T11:55** — fill-forward pass; all 9 process steps + index.html ✅ on disk; ONLY missing: `_outputs/close-out-checklist.md`. Gate 🔓 ready for tight resume. Brief: `_session-graciela-frio-readiness-needs-keystone.md`.
  ...
  - `graciela.nueces` — Wave 3 / ⚡ Catalyst / Sonnet 4.6 — **Cascade-Fill: Get Chance's WLM Forms Signable.** Hood-locked. Probes pdftk→pymupdf→reportlab→companion-print; every tier produces a signable artifact. Renders Q&A page from `#needs-human-input` rollup; refreshes LOB omega + Chance dashboard. Brief: `_session-graciela-nueces-cascade-fill.md` · 🔓 **ready** 2026-04-29.
...
Authored from approved plan. Architectural keystone per plan = introspection-externalization paired loop (steps 0200/0250). Voice contract: plain North Texas deal language for Chance-facing artifacts only; technical citations preserved in internal artifacts. Dan's lock-ins (2026-04-29 AskUserQuestion round): (1) property scope = real lat/lon supplied via Maps link; (2) deadline strategy = research-driven, ask Chance only irreducibles; (3) reply path = phone call, Dan transcribes; (4) network play = quiet/personal-only for v1.
